# meikikai/ocr/providers/dummy/provider.py
import logging
...
from meikikai.ocr.interface import OcrProvider, Paragraph, Word, BoundingBox
...
class DummyProvider(OcrProvider):
    ...
    def scan(self, image: Image.Image) -> Optional[List[Paragraph]]:
        ...
        2. Convert the proprietary data format into MeikiKai's standard format
        ...
        try:
            ...
            mock_ocr_result = [
                ...
                },
                {
                    ...
                    "words": [
                        ...
                        # MeikiKai's hit-scanning works well with both approaches.
            ...
            # OCR engine into the format MeikiKai understands (`List[Paragraph]`).
            ...
            for ocr_line in mock_ocr_result:
                ...
                # MeikiKai requires NORMALIZED coordinates (from 0.0 to 1.0).
